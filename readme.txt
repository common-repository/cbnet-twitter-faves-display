...
Donate https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=QP3N9HUSYJPK6
Tags: cbnet, twitter, twitter favorites, twitter tools, widget
...
This plugin is a widget to add the Twitter Tools Faves Widget (http://twitter.com/goodies/widget_faves), including all configurable options, with no need to copy/paste code.
...
3. Find the widget titled 'cbnet Twitter Faves Display'
...
* **Twitter User ID**: User Id for the Twitter user favorites you wish to display. (Note: you can use *any* Twitter profile, not just your own)
...
= 0.1 =
* Initial Release
* All configurable settings are available. Note: screenshots taken from cbnet Twitter List Display plugin.
